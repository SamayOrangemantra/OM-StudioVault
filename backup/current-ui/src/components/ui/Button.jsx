...
const VARIANTS = {
  primary:
    'bg-accent text-accent-foreground shadow-soft hover:opacity-90 hover:shadow-panel',
  outline:
    'border border-border bg-surface text-text hover:bg-surface-2 hover:border-accent/40',
